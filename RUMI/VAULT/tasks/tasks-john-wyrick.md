# Task List: John Wyrick (CEO / Spiritual Director)

Rumi App — Documents and Deliverables Needed from John  
...
### 1. Founder Equity Discussion
- **What:** Participate in equity split negotiation with all founders
- **Why blocking:** Investors will ask about the cap table. "We haven't decided" is a red flag.
- **Deliverable:** Agreement on equity percentages
- **Reference:** VAULT/09-cap-table.md, VAULT/analysis/equity-fairness-analysis.md

### 2. IP Assignment — Rumi Content Corpus
- **What:** Inventory all Rumi content created to date AND sign IP assignment transferring it to the company
- **Why blocking:** If the content IP belongs to John personally (not the company), investors will flag this as a critical risk. This is the company's primary asset.
- **Deliverable:** 
  - Written inventory: number of Masnavi translations, modern retellings, guided journey scripts
  - Signed IP assignment agreement (after incorporation)
- **Reference:** VAULT/08-investor-data-room-checklist.md (Section 5: IP Assignment Agreements)

### 3. Prior IP Disclosure
- **What:** Disclose any prior intellectual property you want to EXCLUDE from the company assignment
- **Why blocking:** Required in the founder agreement
...
### 6. Content Sample — One Guided Journey
- **What:** Create one complete guided journey experience that could be demoed to investors
- **Why important:** Lets investors *feel* the product, not just hear about it
- **Deliverable:** Written guided journey (text + any audio direction notes)
- **Reference:** VAULT/08-investor-data-room-checklist.md (Section 6: Product Roadmap)

### 7. Content Inventory Summary
- **What:** Full inventory of all Rumi content created to date
- **Deliverable:** Document listing: count and titles of translations, retellings, scripts
- **Reference:** VAULT/08-investor-data-room-checklist.md (Section 7: Content Inventory)

### 8. "Why Can't Calm Just Add a Rumi Section?" — Prepared Answer
- **What:** Articulate the competitive moat in your own words
